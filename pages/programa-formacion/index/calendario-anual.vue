<template>
  <div>
    ...
    <ul>
        <li v-for="(eje,i) in ejeFormativo" :key="i">
            {{eje.name}}
            <ul>
            <li v-for="(mod, j) in eje.modulos" :key="j">
                {{mod.name}}
                <ul>
                    <li v-for="(itinerario,k) in mod.itinerario" :key="k">
                    {{itinerario}}
                    </li>
                </ul>
            </li>
...
<script>
import ejeFormativo from "@/static/data/eje-formativo.json";
